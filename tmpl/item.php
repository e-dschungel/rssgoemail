        ...
        <tr>
            <td class="mcnTextBlockInner" style="padding-top:9px;" valign="top">
                ...
                <table style="max-width:100%; min-width:100%;" class="mcnTextContentContainer" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                    <tbody><tr>                        
                        <td class="mcnTextContent" style="padding: 0px 18px 9px;color: #1B1B1B;" valign="top">
                        
                            <div style="text-align: left;"><span style="font-size:18px"><strong><?php echo $content['##ITEM_TITLE##']; ?></strong></span><span style="padding-left:20px">(<?php echo $content['##ITEM_DATE##']; ?>)</span></div>
                        </td>
                    </tr>
                </tbody></table>
                <!--[if mso]>
            ...
            <table class="mcnCaptionRightTextContentContainer" width="352" cellspacing="0" cellpadding="0" border="0" align="right">
                <tbody><tr>
                    <td class="mcnTextContent" valign="top">
                        <div style="text-align: left;"><?php echo $content['##ITEM_CONTENT##']; ?></div>
                    </td>
                </tr>
            </tbody></table>
        </td>
